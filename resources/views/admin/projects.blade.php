...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .badge-taken { background: var(--admin-taken-bg); color: var(--admin-taken); }
        .badge-available { background: var(--admin-info-bg); color: var(--admin-info); }
    ...
    <div class="admin-shell">
        ...
        <nav class="admin-nav-wrap" aria-label="Admin navigation">
            <div class="admin-nav">
                ...
                <a href="{{ route('admin.projects') }}" class="admin-nav-link is-active">Projects</a>
