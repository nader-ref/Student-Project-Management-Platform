...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .badge-info { background: var(--admin-indigo-bg); color: var(--admin-indigo); }
    ...
    <div class="admin-shell">
        ...
        <nav class="admin-nav-wrap" aria-label="Admin navigation">
            <div class="admin-nav">
                ...
                <a href="{{ route('admin.submissions') }}" class="admin-nav-link is-active">Submissions</a>
