      ...
      <div class="cards-grid">
        ...
        @foreach($requests as $request)
         @if($request->nameone == Session::get('name')||$request->nametwo == Session::get('name')||$request->namethree == Session::get('name'))
            ...
            <div class="value">{{$request->projectid}} <span class="unit">projectid</span></div>
              ...
              @else
               <div  class="bg-red-600 hover:bg-gray-800 text-white px-4 py-2 text-lg font-bold rounded-lg border-2 border-black shadow-md transition-all flex items-center gap-3">
                 pending 
               </div>
              @endif
